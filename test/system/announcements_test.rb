...
class AnnouncementsTest < ApplicationSystemTestCase
  ...
  test "creating a Announcement" do
    ...
    fill_in "Ban", with: @announcement.ban
    check "Hot sale" if @announcement.hot_sale
    fill_in "Location", with: @announcement.location
    fill_in "Purpose", with: @announcement.purpose
    fill_in "Rating", with: @announcement.rating
    check "Visibility" if @announcement.visibility
